...
public class sendInboundStock2Magento extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) {
		String methodName ="com.wmsapi.servlet.sendInboundStock2Magento()";
		...
		try {
			...
			// call real-server URL
			//result = callAPI("https://wmsapi.isecommerce.co.kr:3133/recvApi", params);
			
			
			result = callAPI("http://wmsapi.itlinetest.com:3133/recvApi", params);
			...
			RequestDispatcher rd = request.getRequestDispatcher("/testRedirect.jsp");
...
//			logger.debug("callAPI exception is : " + e);
			e.printStackTrace();
		}
//		logger.debug("callAPI result is : "+result);
		return result;
	}
